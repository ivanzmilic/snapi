...
//  fp_t wmu[]={0.1184634425,0.2393143352,0.2844444444,0.2393143352,0.1184634425};
  ...
  fp_t wmu[]={1.0}; // ={1.0/3.6,4.0/9.0,1.0/3.6};
...
int atmos_pp::formal_pert_analytical_taugrid(fp_t **** dS, fp_t *** op, fp_t *** em, fp_t **** op_pert, fp_t **** em_pert, fp_t theta, fp_t phi, fp_t boundary){
  return 0;
}
