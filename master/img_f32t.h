#ifndef __IMG_F32T_H__  // __IMG_F32T_H__
#define __IMG_F32T_H__
...
class image_f32t:public image_t{
  float32_t **pic;
public:
  image_f32t(int,int);
  image_f32t(const char*,io_class&);
  image_f32t(image_t*,io_class&);
  image_f32t(image_t**,int,io_class&);
  image_f32t(const char*,const char*,io_class&);
  image_f32t(const char *dir,const char *fntmpl,int num,io_class &io);
  virtual ~image_f32t(void);
