...
for ii in range (2,3):
	...
	for i in range (0,N_tau):
		...
		ax = axes.flat[fig_no]
		im = ax.imshow(cube1_to_show[i],origin='lower',cmap=maps[ii],vmin=m-3*s,vmax=m+3*s,extent=[x_scale[0]*3,x_scale[-1]*3,y_scale[0]*3,y_scale[-1]*3])
		if (i==0):
